 ...
 * Generated at: 2021-11-28 10:49:53 UTC
...
public final class mySubscribeList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	boolean check = false;
      ...
      out.write("	\r\n");
      out.write("	#table_subscribe{width: 100%;}\r\n");
      out.write("	\r\n");
      out.write("	#toProfileBtn{float: left; background: #AFEEEE;}\r\n");
      out.write("	\r\n");
      out.write("	#table_subscribe span{\r\n");
      out.write("		position: relative; top: -20px;\r\n");
      out.write("	}\r\n");
      out.write("	\r\n");
      out.write("	.btn{\r\n");
      ...
      out.write("	\r\n");
      out.write("	.subscribePhoto{width: 60px; height: 60px; border-radius: 30px;}\r\n");
      out.write("</style>\r\n");
      out.write("<body>\r\n");
      out.write("	");
      out.write('\r');
 ...
 if(m.getUserPicNew() == null) { 
      ...
      out.write("</span><br>\r\n");
      out.write("			<span id=\"subscribeList\" style=\"color: #00CED1\">구독 회원</span><br>\r\n");
      ...
      out.write("		\r\n");
      out.write("		<table id=\"table_subscribe\">\r\n");
      out.write("			<tr>\r\n");
      out.write("				<td colspan=\"2\"><input type=\"button\" class=\"btn\" id=\"toProfileBtn\" value=\"&lt;&lt; 글 보러가기\" onclick=\"javascript:history.back()\"><br><br></td>\r\n");
      out.write("			</tr>\r\n");
      out.write("			");
 if(list.isEmpty()) { 
      out.write("\r\n");
      out.write("			<tr>\r\n");
      out.write("				<td colspan=\"2\">구독한 회원이 없습니다.</td>\r\n");
      out.write("			</tr>\r\n");
      out.write("			");
 } else { 
      out.write("\r\n");
 ...
 if(list.get(i).getToUserPicNew() == null) { 
      out.write("\r\n");
      out.write("								<img class=\"subscribePhoto\" src=\"images/profile_photo.png\">\r\n");
      out.write("							");
 } else { 
      out.write("\r\n");
      out.write("								<img class=\"subscribePhoto\" src=\"");
      out.print( request.getContextPath() );
      out.write("/uploadFiles/");
      out.print( list.get(i).getToUserPicNew() );
      out.write("\">\r\n");
      out.write("							");
 } 
      out.write("\r\n");
      out.write("							&nbsp;&nbsp; <span>");
      out.print( list.get(i).getToUserNick() );
      out.write("</span>\r\n");
      out.write("						</td>\r\n");
      out.write("						<td>\r\n");
      out.write("							");
 if(loginList == null) { 
      out.write("\r\n");
      out.write("								<input type=\"button\" class=\"btn subscribed\" value=\"&nbsp;구독 중&nbsp\">\r\n");
      out.write("							");
 } else { 
      out.write("\r\n");
      out.write("								");
 ...
 if(check){ 
      out.write("\r\n");
      out.write("										<input type=\"button\" class=\"btn subscribed\" value=\"&nbsp;구독 중&nbsp;\">\r\n");
      out.write("									");
 } else { 
      out.write("\r\n");
      out.write("										<input type=\"button\" class=\"btn subscribing\" value=\"구독하기\">\r\n");
      out.write("									");
 } 
      out.write("\r\n");
      out.write("								");
      ...
      out.write("	\r\n");
      out.write("	<script>\r\n");
      out.write("		$('.subscribePhoto').click(function(){\r\n");
      out.write("			location.href=\"");
      out.print( request.getContextPath() );
      out.write("/myProfile.me?userId=\" + $(this).parent().children().eq(0).val();\r\n");
      out.write("		})\r\n");
      out.write("	\r\n");
      out.write("		$('.subscribed').click(function(){\r\n");
      out.write("			location.href=\"");
      out.print( request.getContextPath() );
      out.write("/unsubscribe.me?fromUser=\" + \"");
      out.print( loginUser.getUserId() );
      out.write("\" + \"&toUser=\" + $(this).parent().parent().children().children().eq(0).val() + \"&pageUser=\" + \"");
      out.print( m.getUserId() );
      out.write("\";\r\n");
      out.write("		});\r\n");
      out.write("		\r\n");
      out.write("		$('.subscribing').click(function(){\r\n");
      out.write("			location.href=\"");
      out.print( request.getContextPath() );
      out.write("/subscribe.me?fromUser=\" + \"");
      out.print( loginUser.getUserId() );
      out.write("\" + \"&toUser=\" + $(this).parent().parent().children().children().eq(0).val() + \"&pageUser=\" + \"");
      out.print( m.getUserId() );
      out.write("\";\r\n");
