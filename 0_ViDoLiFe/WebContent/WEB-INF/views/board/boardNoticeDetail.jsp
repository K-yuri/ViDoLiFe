...
<body>
	...
	<div class="contents">
		<div class="board_titleArea">
			<a href="<%= request.getContextPath() %>/list.no">공지 게시판▷</a>
		</div>
		<form action="<%= request.getContextPath() %>/updateBuyForm.no" id="detailForm" method="post">
		...
		<div class="content_part">
			<!-- 작성한 글이 들어가는 부분 -->
			<img src=".\images\mogadishu.jpg" width="100px"><br>
			<%= b.getBoardContent() %>
	...
	<div style="text-align: center;">
		<button id="return_list" onclick="location.href='<%= request.getContextPath() %>/list.bu'">목록으로</button>
	</div>
	...
	<script>
		function deleteBoard() {
			...
			if(bool) {
				$('#detailForm').attr('action', 'delete.bu');
				$('#detailForm').submit();
			}
		}
