...
<body>
	...
	<div id="wrap-all">
		<section id="board_wrap">
			...
			<div id="search_area">
				<form action="<%= request.getContextPath() %>/search.bu" id="detailForm" method="post">
		...
		<div style="text-align: center;">
			<button id="return_list" class="btn" onclick="location.href='<%= request.getContextPath() %>/list.bu'">목록으로</button>
		</div>
	</div>
	<script>
