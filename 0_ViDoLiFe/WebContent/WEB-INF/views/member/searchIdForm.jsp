...
<head>
	...
	<body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%" align="left">
      ...
      <form action="<%= request.getContextPath() %>/search.me" method="post" id="searchId" name="searchId">
		<div class="card-body">
  
        <input type="text" name="userName" id="userName" class="form-control" placeholder="이름" autofocus required><BR>
        <input type="text" name="userEmail" id="userEmail" class="form-control" placeholder="이메일"  required><br>
         <p id="check" class="check"></p><br/>
        <input id="btn-Yes" class="btn btn-lg btn-primary btn-block" type="submit" value="찾기">
      </form>
<!--  	<script type="text/javascript">
      	document.getElementById('btn-Yes').onclick = function(){      		
      		window.open('search.me');
      	}
      	</script> -->
  </body>
</html>