...
public class BoardBuyListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = bService.getListBuyCount();
		...
		ArrayList<Board> list = bService.selectBuyList(pi);
		
		String page = null;
		if(list != null) {
			page = "WEB-INF/views/board/boardBuyList.jsp";
			request.setAttribute("list", list);
			request.setAttribute("pi", pi);
		} else {
			page = "WEB-INF/views/common/errorPage.jsp";
			request.setAttribute("msg", "공동구매 게시판 조회 실패");
		}
